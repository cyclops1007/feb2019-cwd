...
window.onload = function initializeApp() {
    ...
    const theFormCheckers = {
        ...
        achternaam: checkBoth( hasMaxLength(20) ,hasMinimumLength(3) ),// isRequired is a checker defined in formValidation.js
        postcode: optional( isaPostCode ),  // isaPostCode is a checker defined in this file.
